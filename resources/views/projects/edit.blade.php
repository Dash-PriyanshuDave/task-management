    ...
    <div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-xl rounded-2xl p-8 max-w-lg mx-auto">
                <h2 class="text-3xl font-bold text-gray-900 mb-6">Edit Project: {{ $project->name }}</h2>
                ...
                <form method="POST" action="{{ route('projects.update', $project) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="name" name="name" type="text" required 
                               class="w-full px-5 py-4 bg-white border border-gray-300 rounded-2xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition-all duration-300 @error('name') ringt-2 ring-red-400 @enderror"
                               value="{{ $project->name }}">
                        @error('name')
